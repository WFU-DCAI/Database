...
for filename in os.listdir(annotator_statuses_dir):
    ...
    annotator_map = build_lookup("annotators", "annotator_names", "annotator_id")

    annotator_df2 = annotator_df.copy()
    annotator_df2["annotator_id"] = annotator_df2["annotator_names"].map(annotator_map)
